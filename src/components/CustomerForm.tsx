...
const CustomerForm: React.FC<CustomerFormProps> = ({ customerId, onSave }) => {
  ...
  useEffect(() => {
    if (customerId) {
      ...
      fetch(`http://192.168.1.5:5000/api/customers/${customerId}`)
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
      e.preventDefault();
    const url = customerId ? `http://192.168.1.5:5000/api/customers/${customerId}` : 'http://192.168.1.5:5000/api/customers';
